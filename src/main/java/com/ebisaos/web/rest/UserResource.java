...
import com.ebisaos.security.AuthoritiesConstants;
import com.ebisaos.service.MailService;
import com.ebisaos.service.UserService;
import com.ebisaos.service.dto.AdminUserDTO;
import com.ebisaos.web.rest.errors.BadRequestAlertException;
import com.ebisaos.web.rest.errors.EmailAlreadyUsedException;
import com.ebisaos.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.ebisaos.domain.User} entity, and needs to
...
public class UserResource {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAuthority('" + AuthoritiesConstants.ADMIN + "') or hasAuthority('" + AuthoritiesConstants.EBISA
            + "')")
