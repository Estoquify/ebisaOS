...
import com.ebisaos.repository.SetorRepository;
...
public class SetorResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<Setor> createSetor(@RequestBody Setor setor) throws URISyntaxException {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Setor> updateSetor(@PathVariable(value = "id", required = false) final Long id, @RequestBody Setor setor)
    ...
    public ResponseEntity<Setor> partialUpdateSetor(@PathVariable(value = "id", required = false) final Long id, @RequestBody Setor setor)
        throws URISyntaxException {
