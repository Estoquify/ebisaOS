...
public class SolicitacaoService {
    ...
    public Page<SolicitacaoAvaliacaoGInfraDTO> listaPageSolicitacaoAvaliacaoGInfra(Pageable pageable, Map<String, String> params) {
        String statusString = params.get("filtrarNegados");
        Boolean filtrarNegados = null;

        if (statusString != null) {
            if ("null".equalsIgnoreCase(statusString)) {
                filtrarNegados = null; 
            } else {
                filtrarNegados = Boolean.parseBoolean(statusString); 
            }
        }
        Long countSolicitacao = solicitacaoRepository.countListagemSolicitacaoAvaliacaoGInfra(params.get("pesquisa"), filtrarNegados);
    ...
    public SolicitacaoViewMaterialDTO montarVisualizadorMaterial(Long idSolicitacao) {
        ...
        solicitacaoViewMaterialDTO.setAvaliacaoOrcamento(verificarAvaliacaoOrcamento(idSolicitacao));
    ...
    public SolicitacaoViewServicoDTO montarVisualizadorSolicitacao(Long idSolicitacao) {
        ...
        solicitacaoViewServicoDTO.setAvaliacaoOrcamento(verificarAvaliacaoOrcamento(idSolicitacao));
    ...
    public Boolean verificarAvaliacaoOrcamento(Long idSolicitacao) {
