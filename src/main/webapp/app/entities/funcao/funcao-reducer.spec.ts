...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './funcao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCAO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FUNCAO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FUNCAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FUNCAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FUNCAO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FUNCAO actions', async () => {
      const arg = 42666;
