...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGSTOCKITENS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOGSTOCKITENS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOGSTOCKITENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOGSTOCKITENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOGSTOCKITENS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOGSTOCKITENS actions', async () => {
      const arg = 42666;
