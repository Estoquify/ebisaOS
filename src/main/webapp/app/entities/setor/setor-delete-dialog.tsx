...
export const SetorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ebisaOsApp.setor.delete.question">
        <Translate contentKey="ebisaOsApp.setor.delete.question" interpolate={{ id: setorEntity.id }}>
          Are you sure you want to delete this Setor?
        </Translate>
      </ModalBody>
      <ModalFooter>
