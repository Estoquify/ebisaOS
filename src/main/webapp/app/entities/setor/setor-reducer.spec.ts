...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './setor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SETOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SETOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SETOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SETOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SETOR actions', async () => {
      const arg = 42666;
