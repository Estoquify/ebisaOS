...
export const Setor = () => {
  ...
  const setorList = useAppSelector(state => state.setor.entities);
      ...
      <h2 id="setor-heading" data-cy="SetorHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="ebisaOsApp.setor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/setor/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ebisaOsApp.setor.home.createLabel">Create new Setor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {setorList && setorList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/setor/${setor.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/setor/${setor.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ebisaOsApp.setor.home.notFound">No Setors found</Translate>
            </div>
          )
        )}
      </div>
