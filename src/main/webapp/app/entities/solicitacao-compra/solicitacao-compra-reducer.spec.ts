...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './solicitacao-compra.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLICITACAOCOMPRA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOLICITACAOCOMPRA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOLICITACAOCOMPRA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOLICITACAOCOMPRA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOLICITACAOCOMPRA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOLICITACAOCOMPRA actions', async () => {
      const arg = 42666;
