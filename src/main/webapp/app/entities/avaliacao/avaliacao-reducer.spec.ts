...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './avaliacao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVALIACAO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AVALIACAO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AVALIACAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AVALIACAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AVALIACAO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AVALIACAO actions', async () => {
      const arg = 42666;
