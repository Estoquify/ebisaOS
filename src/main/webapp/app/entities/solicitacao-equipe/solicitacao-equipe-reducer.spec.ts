...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './solicitacao-equipe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLICITACAOEQUIPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOLICITACAOEQUIPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOLICITACAOEQUIPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOLICITACAOEQUIPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOLICITACAOEQUIPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOLICITACAOEQUIPE actions', async () => {
      const arg = 42666;
