...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLICITACAO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOLICITACAO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOLICITACAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOLICITACAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOLICITACAO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOLICITACAO actions', async () => {
      const arg = 42666;
