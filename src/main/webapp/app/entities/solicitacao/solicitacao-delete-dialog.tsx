...
export const SolicitacaoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ebisaOsApp.solicitacao.delete.question">
        <Translate contentKey="ebisaOsApp.solicitacao.delete.question" interpolate={{ id: solicitacaoEntity.id }}>
