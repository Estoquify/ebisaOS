...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './orgao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGAO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGAO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGAO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGAO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGAO actions', async () => {
      const arg = 42666;
